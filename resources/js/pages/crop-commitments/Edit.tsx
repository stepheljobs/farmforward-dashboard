...
import { CropPlanner, CropType } from '@/types/crop-planner';
...
export default function Edit({ cropPlanner, cropTypes }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        crop_type_id: cropPlanner.crop_type_id.toString(),
        planned_area_hectares: cropPlanner.planned_area_hectares.toString(),
        estimated_quantity: cropPlanner.estimated_quantity.toString(),
        planned_planting_date: cropPlanner.planned_planting_date.split('T')[0],
        expected_harvest_date: cropPlanner.expected_harvest_date.split('T')[0],
        consultant_notes: cropPlanner.consultant_notes || '',
        location: cropPlanner.location || '',
        variety: cropPlanner.variety || '',
        volume_inputs: cropPlanner.volume_inputs?.toString() || '',
        volume_inputs_type: cropPlanner.volume_inputs_type || '',
        contact_number: cropPlanner.contact_number || '',
    });

    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(route('crop-planners.update', cropPlanner.id));
    };
            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6">
                            <h2 className="text-2xl font-semibold mb-6">Edit Crop Plan</h2>
